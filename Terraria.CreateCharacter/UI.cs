...
namespace Terraria.CreateCharacter
{
	public class UI
	{
		...
		public void Draw(WorldView view)
		{
			...
			Vector2 value = textFont.MeasureString(text);
			Main.spriteBatch.DrawString(textFont, text, vector + zero, Color.White, 0f, value * 0.5f, textScale, SpriteEffects.None, 0f);
			if (player != null)
			{
