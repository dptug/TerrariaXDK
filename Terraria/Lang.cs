...
namespace Terraria
{
	internal sealed class Lang
	{
		...
		public static string controls(CONTROLS i)
		{
			...
			{
			case 2:
				return CONTROLS_DE[(int)i];
			case 4:
				return CONTROLS_FR[(int)i];
			case 3:
				return CONTROLS_IT[(int)i];
			case 5:
				return CONTROLS_ES[(int)i];
			default:
				return CONTROLS_EN[(int)i];
			}
		}
		...
		public static ControlDesc[] controls()
		{
			...
			{
			case 2:
				return MENU_CONTROLS_DE;
			case 4:
				return MENU_CONTROLS_FR;
			case 3:
				return MENU_CONTROLS_IT;
			case 5:
				return MENU_CONTROLS_ES;
			default:
				return MENU_CONTROLS_EN;
			}
		}
		...
		public static string itemPrefix(int prefix)
		{
			...
			{
			case 2:
				return ITEM_PREFIX_DE[prefix];
			case 4:
				return ITEM_PREFIX_FR[prefix];
			case 3:
				return ITEM_PREFIX_IT[prefix];
			case 5:
				return ITEM_PREFIX_ES[prefix];
			default:
				return ITEM_PREFIX_EN[prefix];
			}
		}

		public static string dialog(Player player, int l)
		{
			string str = NPC.chrName[17];
			string text = NPC.chrName[18];
			string str2 = NPC.chrName[22];
			string text2 = NPC.chrName[19];
			string text3 = NPC.chrName[20];
			string str3 = NPC.chrName[38];
			_ = NPC.chrName[54];
			string text4 = NPC.chrName[107];
			_ = NPC.chrName[108];
			string text5 = NPC.chrName[124];
			if (lang <= 1)
			{
				switch (l)
				{
				...
				case 33:
					return "I wish " + str3 + " would be more careful.  I'm getting tired of having to sew his limbs back on every day.";
				case 34:
					return "Hey, has " + text2 + " mentioned needing to go to the doctor for any reason? Just wondering.";
				case 35:
					return "I need to have a serious talk with " + str2 + ". How many times a week can you come in with severe lava burns?";
				case 36:
				...
				case 58:
					return "I heard there is a doll that looks very similar to " + str2 + " somewhere in the underworld.  I'd like to put a few rounds in it.";
				case 59:
				...
				case 62:
					return "Don't bother with " + str3 + ", I've got all you need right here.";
				case 63:
					return "What's " + str3 + "'s problem? Does he even realize we sell completely different stuff?";
				case 64:
				...
				case 165:
					return "Hey, " + player.name + ", did you just come from " + text4 + "'s? Did he say anything about me by chance?";
				case 166:
			...
			else if (lang == 2)
			{
				...
				case 13:
					return "Toll. Ich kann " + text5 + " und " + text + " von hier aus diskutieren hören.";
				case 14:
				...
				case 33:
					return "Ich wünschte, " + str3 + " wäre vorsichtiger. Es nervt mich, täglich seine Glieder zusammennähen zu müssen.";
				case 34:
					return "Heh, hat " + text2 + " den Grund für einen notwendigen Arztbesuch erwähnt? Ich wundere mich nur.";
				case 35:
					return "Ich muss mal ein ernsthaftes Wort mit  " + str2 + " reden. Wie oft kann man in einer Woche mit schweren Lavaverbrennungen hereinkommen?";
				case 36:
				...
				case 58:
					return "Ich habe gehört, es gibt eine Puppe in der Unterwelt, die " + str2 + " sehr ähnlich sieht. Ich würde sie gerne mit ein paar Kugeln durchlöchern.";
				case 59:
					return "Mach schnell! Ich habe in einer Stunde ein Date mit " + text + ".";
				case 60:
					return "Ich möchte das, was " + text + "  verkauft. Was heißt, sie verkauft nichts?";
				case 61:
					return text3 + " ist hübsch. Zu dumm, dass sie so prüde ist.";
				case 62:
					return "Halte dich nicht mit " + str3 + " auf, ich habe alles, was du brauchst, hier.";
				case 63:
					return "Was ist eigentlich mit " + str3 + " los? Kriegt der mal mit, dass wir ganz andere Sachen verkaufen?";
				case 64:
				...
				case 70:
					return "Ich wünschte, " + text2 + " würde aufhören, mit mir zu flirten. Versteht er nicht, dass ich 500 Jahre alt bin?";
				case 71:
					return "Warum versucht " + str + " , mir Engelsstatuen zu verkaufen? Jeder weiß, dass sie nutzlos sind.";
				case 72:
				...
				case 112:
					return "Wenn ich jünger wäre, würde ich mit " + text + " ausgehen wollen. Ich war mal ein Womanizer.";
				case 113:
				...
				case 144:
					return "Hallo, " + text4 + "! Was kann ich heute für dich tun?";
				case 145:
					return "Hallo, " + text + "! Was kann ich heute für dich tun?";
				case 146:
				...
				case 165:
					return "Sag, " + player.name + ", kommst du gerade von " + text4 + "? Hat er vielleicht etwas über mich gesagt?";
				case 166:
					return text2 + " spricht immer davon, auf meine Druckplatten zu drücken. Ich habe ihm gesagt, die ist zum Drauftreten.";
				case 167:
			...
			else if (lang == 3)
			{
				...
				case 13:
					return "Fantastico! Da qui sento " + text5 + " e " + text + " discutere.";
				case 14:
				...
				case 33:
					return "Vorrei che " + str3 + " fosse più attento.  Mi sto stancando di dovergli ricucire gli arti ogni giorno.";
				case 34:
					return "Ehi, " + text2 + " ha detto di dover andare dal dottore per qualche ragione? Solo per chiedere.";
				case 35:
					return "Devo parlare seriamente con " + str2 + ". Quante volte a settimana si può venire con gravi ustioni da lava?";
				case 36:
				...
				case 58:
					return "Ho sentito che c'è una bambola molto simile a " + str2 + " nel sotterraneo. Vorrei metterci dei proiettili.";
				case 59:
				...
				case 62:
					return "Lascia stare " + str3 + ", qui ho tutto ciò che ti serve.";
				case 63:
					return "Qual è il problema di " + str3 + "? Almeno lo sa che vendiamo oggetti diversi?";
				case 64:
				...
				case 112:
					return "Fossi più giovane, chiederei a " + text + " di uscire. Avevo un successone con le ragazze.";
				case 113:
				...
				case 165:
					return "Ehi, " + player.name + ", sei appena stato da " + text4 + "? Ha detto qualcosa di me, per caso?";
				case 166:
			...
			else if (lang == 4)
			{
				...
				case 13:
					return "Super. J'entends " + text5 + " et " + text + " se disputer d'ici.";
				case 14:
				...
				case 33:
					return "J'aimerais bien que " + str3 + " fasse plus attention. J'en ai assez de lui faire des points de suture chaque jour.";
				case 34:
					return "Je me demande si " + text2 + " a dit qu'il avait besoin d'un docteur.";
				case 35:
					return "Il va falloir que je discute sérieusement avec " + str2 + ". Combien de fois par semaine allez-vous revenir ici avec des brûlures au second degré ?";
				case 36:
				...
				case 58:
					return "J'ai entendu dire qu'il y aurait une poupée qui ressemblerait beaucoup à " + str2 + " dans le monde inférieur. J'aimerais bien lui coller quelques pruneaux.";
				case 59:
					return "Dépêchez-vous, j'ai un rencard avec " + text + " dans une heure.";
				case 60:
				...
				case 62:
					return "Ne vous embêtez pas avec " + str3 + ", j'ai tout ce qu'il vous faut ici.";
				case 63:
					return "C'est quoi le problème de " + str3 + " ? Est-ce qu'il réalise seulement que l'on vend du matériel complètement différent ?";
				case 64:
				...
				case 70:
					return "Ce serait bien si " + text2 + " cessait de me courtiser. Il n'a pas l'air de réaliser que j'ai 500\u00a0ans.";
				case 71:
				...
				case 165:
					return "Au fait, " + player.name + ", vous venez de voir  " + text4 + " ? Est-ce qu'il aurait parlé de moi, par hasard ?";
				case 166:
			...
			else if (lang == 5)
			{
				...
				case 13:
					return "¡Vaya! Desde aquí se oye cómo discuten " + text5 + " y " + text + ".";
				case 14:
				...
				case 33:
					return "Ojalá " + str3 + " tuviera más cuidado. Ya me estoy hartando de tener que coserle las extremidades todos los días.";
				case 34:
					return "Oye, por curiosidad, ¿ha dicho " + text2 + " por qué tiene que ir al médico?";
				case 35:
					return "Debo hablar en serio con " + str2 + ". ¿Cuántas veces crees que puedes venir en una semana con quemaduras de lava graves?";
				case 36:
				...
				case 58:
					return "Dicen que en alguna parte del Inframundo hay una muñeca que se parece mucho a " + str2 + ". Ojalá pudiera usarla para practicar el tiro al blanco.";
				case 59:
				...
				case 62:
					return "Olvídate de " + str3 + ", yo tengo todo lo que necesitas aquí y ahora.";
				case 63:
					return "¿Qué mosca le ha picado a " + str3 + "? ¿Aún no sabe que vendemos cosas totalmente distintas?";
				case 64:
				...
				case 71:
					return "¿Por qué se empeña " + str + " en intentar venderme una estatua de ángel? Todo el mundo sabe que no sirven para nada.";
				case 72:
				...
				case 99:
					return "Seguro que " + text + " te ayudará si pierdes una extremidad jugando con estas monadas...";
				case 100:
				...
				case 165:
					return "Eh, " + player.name + ", ¿acabas de llegar de la casa de " + text4 + "? ¿Por casualidad no te hablaría de mí?";
				case 166:
					return text2 + " sigue insistiendo en pulir mi place de presión. Ya le he dicho que funciona pisándola.";
				case 167:
		...
		public static string deathMsgString(uint encoded)
		{
			...
			else if (lang == 2)
			{
				...
				{
				case 0:
					text = " wurde getötet von";
					break;
				case 1:
					text = " wurde vernichtet";
					break;
				case 2:
					text = " wurde ermordet";
					break;
				case 3:
					text = " wurde das Gesicht heruntergerissen";
					break;
				case 4:
					text = " wurden die Eingeweide herausgerissen";
					break;
				case 5:
					text = " wurde zerstört";
					break;
				case 6:
					text = " wurde der Schädel eingeschlagen";
					break;
				case 7:
					text = " wurde massakriert";
					break;
				case 8:
					text = " wurde gepfählt";
					break;
				case 9:
					text = " wurde in zwei Hälften gerissen";
					break;
				case 10:
					text = " wurde geköpft";
					break;
				case 11:
					text = "wurden die Arme ausgerissen";
					break;
				case 12:
					text = " sah dabei zu, wie die eigenen Eingeweide herausquollen";
					break;
				case 13:
					text = " wurde brutal seziert";
					break;
				default:
					text = " liess sich den Kopf wegreissen";
					break;
				}
				switch (num)
				{
			...
			else if (lang == 3)
			{
				...
				case 0:
					...
					break;
				case 1:
					text = " è stato sventrato";
					break;
				case 2:
					text = " è stato assassinato";
					break;
				case 3:
					text = " è stato distrutto";
					break;
				case 4:
					text = " è stato massacrato";
					break;
				case 5:
					text = " è stato distrutto";
					break;
				case 6:
					text = " il cranio è stato spappolato";
					break;
				case 7:
					text = " è stato massacrato";
					break;
				case 8:
					text = " ha visto uscire le sue interiora ";
					break;
				case 9:
					text = " è stato spezzato a metà";
					break;
				case 10:
					text = " è stato decapitato";
					break;
				case 11:
					text = " le braccia sono state spezzate";
					break;
				default:
					text = " è stato tagliato a metà";
					break;
				}
				switch (num)
				{
			...
			else if (lang == 4)
			{
				...
				{
				case 0:
					text = " s'est fait massacrer";
					break;
				case 1:
					text = " s'est fait éviscérer";
					break;
				case 2:
					text = " s'est fait assassiner";
					break;
				case 3:
					text = " s'est fait défigurer";
					break;
				case 4:
					text = " a vu ses entrailles tomber à ses pieds";
					break;
				case 5:
					text = " s'est fait détruire";
					break;
				case 6:
					text = " s'est fait arracher la tête";
					break;
				case 7:
					text = " s'est fait tuer";
					break;
				case 8:
					text = " s'est fait empaler";
					break;
				case 9:
					text = " s'est fait brutalement découper";
					break;
				case 10:
					text = " a été décapité";
					break;
				case 11:
					text = " s'est fait déchiqueter les bras";
					break;
				case 12:
					text = " s'est fait couper en tranches";
					break;
				default:
					text = " a perdu la tête";
					break;
				}
				switch (num)
				{
		...
		public static string tutorial(Tutorial t)
		{
			...
			{
			case 2:
				return TUTORIAL_DE[(int)t];
			case 4:
				return TUTORIAL_FR[(int)t];
			case 3:
				return TUTORIAL_IT[(int)t];
			case 5:
				return TUTORIAL_ES[(int)t];
			default:
				return TUTORIAL_EN[(int)t];
			}
		}
	}
}
