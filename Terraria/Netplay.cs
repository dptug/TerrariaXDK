...
public sealed class Netplay
{
	...
	public static void InviteAccepted()
	{
		...
		if (Main.isTrial)
		{
			MessageBox.Show(playerIndex, Lang.menu[5], Lang.inter[69], new string[1] { Lang.menu[90] });
		}
		else if (!UI.AllPlayersCanPlayOnline())
		{
			MessageBox.Show(playerIndex, Lang.menu[5], Lang.inter[68], new string[1] { Lang.menu[90] });
		}
		else
		{
