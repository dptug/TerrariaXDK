...
public struct Tile
{
	...
	public int wallFrameNumber
	{
		...
		set
		{
			flags = (Flags)((uint)(byte)value | (uint)(flags & ~Flags.WALLFRAME_MASK));
		}
	}
	...
	public int checkingLiquid
	{
		...
		set
		{
			flags = (Flags)((uint)(byte)value | (uint)(flags & ~Flags.CHECKING_LIQUID));
		}
	}
	...
	public int skipLiquid
	{
		...
		set
		{
			flags = (Flags)((uint)(byte)value | (uint)(flags & ~Flags.SKIP_LIQUID));
		}
	}
	...
	public int wire
	{
		...
		set
		{
			flags = (Flags)((uint)(byte)value | (uint)(flags & ~Flags.WIRE));
		}
	}
	...
	{
		active = 0;
		flags = ~(Flags.WALLFRAME_MASK | Flags.HIGHLIGHT_MASK | Flags.VISITED | Flags.WIRE | Flags.CHECKING_LIQUID | Flags.SKIP_LIQUID);
		type = 0;
		wall = 0;
		wallFrameX = 0;
		wallFrameY = 0;
