							...
							while (num4 >= 0)
							{
								try
								{
									fixed (Tile* ptr3 = &Main.tile[num5 + 34, num3 + 34])
									{
										...
										{
											num6 = ((array2[num3] < array3[num5]) ? ((array2[num3] + 1) * 4 + array3[num5] * array3[num5]) : ((array2[num3] <= array3[num5]) ? (array2[num3] * array2[num3] + array3[num5] * array3[num5]) : (array2[num3] * array2[num3] + (array3[num5] + 1) * 4)));
											uint num7;
											if (ptr3->active != 0)
											{
