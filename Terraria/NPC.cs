...
public sealed class NPC
{
	...
	public static byte[] npcFrameCount = new byte[168]
	{
		...
		5, 3, 2, 7, 7, 4, 2, 8, 1, 5,
		1, 2, 4, 16, 5, 4, 4, 15, 15, 15,
		15, 2, 4, 6, 6, 18, 16, 1, 1, 1,
		1, 1, 1, 4, 3, 1, 1, 1, 1, 1,
		1, 5, 6, 7, 16, 1, 1, 16, 16, 12,
		20, 21, 1, 2, 2, 3, 6, 1, 1, 1,
		15, 4, 11, 1, 14, 6, 6, 3, 1, 2,
		2, 1, 3, 4, 1, 2, 1, 4, 2, 1,
		15, 3, 16, 4, 5, 7, 3, 5, 4, 15,
		2, 6, 15, 11, 15, 15, 3, 3, 3, 1,
		1, 1, 1, 1, 1, 2, 6, 2
	};
	...
	public static void setNames()
	{
		...
		if (chrName[22] == null)
		{
			int num = WorldGen.genRand.Next(35);
			chrName[22] = num switch
			{
				0 => "Jake", 
				1 => "Connor", 
				2 => "Tanner", 
		...
		if (chrName[20] == null)
		{
			int num = WorldGen.genRand.Next(22);
			chrName[20] = num switch
			{
				0 => "Alalia", 
				1 => "Alalia", 
				2 => "Alura", 
		...
		if (chrName[108] == null)
		{
			int num = WorldGen.genRand.Next(21);
			chrName[108] = num switch
			{
				0 => "Dalamar", 
				1 => "Dulais", 
				2 => "Elric", 
		...
		if (chrName[107] == null)
		{
			int num = WorldGen.genRand.Next(25);
			chrName[107] = num switch
			{
				0 => "Grodax", 
				1 => "Sarx", 
				2 => "Xon", 
	...
	public void SetDefaults(string Name)
	{
		...
		{
		case "Slimeling":
			SetDefaults(81, 0.6000000238418579);
			name = Name;
			damage = 45;
			defense = 10;
			life = 90;
			...
			break;
		case "Slimeling2":
			SetDefaults(150, 0.6000000238418579);
			name = Name;
			damage = 45;
			defense = 10;
			life = 105;
			...
			break;
		case "Slimer2":
			SetDefaults(81, 0.8999999761581421);
			name = Name;
			damage = 45;
			defense = 20;
			life = 90;
			...
			break;
		case "Green Slime":
			SetDefaults(1, 0.8999999761581421);
			name = Name;
			damage = 6;
			defense = 0;
			life = 14;
			...
			break;
		case "Pinky":
			SetDefaults(1, 0.6000000238418579);
			name = Name;
			damage = 5;
			defense = 5;
			life = 150;
		...
		case "Yellow Slime":
			...
			break;
		case "Jungle Slime":
			SetDefaults(1, 1.100000023841858);
			name = Name;
			damage = 18;
			defense = 6;
			life = 60;
			...
			break;
		case "Little Eater":
			SetDefaults(6, 0.8500000238418579);
			name = Name;
			...
			break;
		case "Big Eater":
			SetDefaults(6, 1.149999976158142);
			name = Name;
			defense = (int)((float)defense * scale);
			damage = (int)((float)damage * scale);
			life = (int)((float)life * scale);
			...
			break;
		case "Short Bones":
			SetDefaults(31, 0.8999999761581421);
			name = Name;
			defense = (int)((float)defense * scale);
			damage = (int)((float)damage * scale);
			life = (int)((float)life * scale);
			...
			break;
		case "Big Boned":
			SetDefaults(31, 1.149999976158142);
			name = Name;
			defense = (int)((float)defense * scale);
			...
			break;
		case "Heavy Skeleton":
			SetDefaults(77, 1.149999976158142);
			name = Name;
			defense = (int)((float)defense * scale);
			damage = (int)((double)((float)damage * scale) * 1.1);
			life = 400;
			...
			break;
		case "Little Stinger":
			SetDefaults(42, 0.8500000238418579);
			name = Name;
			defense = (int)((float)defense * scale);
			damage = (int)((float)damage * scale);
			life = (int)((float)life * scale);
	...
	public void SetDefaults(int Type, double scaleOverride = -1.0)
	{
		...
		frameY = 0;
		frameHeight = (short)(SpriteSheet<_sheetSprites>.src[1088 + type].Height / npcFrameCount[type]);
	...
	{
		Lighting.addLight(rgb: (type == 63) ? new Vector3(0.05f, 0.15f, 0.4f) : ((type != 103) ? new Vector3(0.35f, 0.05f, 0.2f) : new Vector3(0.05f, 0.45f, 0.1f)), i: aabb.X + (height >> 1) >> 4, j: aabb.Y + (height >> 1) >> 4);
		if (direction == 0)
		{
			TargetClosest();
		}
	...
	public static void SpawnNPC()
	{
		...
		for (int j = 0; j < 8; j++)
		{
			if (Main.player[j].active == 0 || Main.player[j].dead)
			{
				continue;
			}
			bool flag3 = false;
			bool flag4 = false;
			bool flag5 = false;
			if (Main.invasionType > 0 && Main.invasionDelay == 0 && Main.invasionSize > 0 && Main.player[j].position.Y < (float)(Main.worldSurfacePixels + 1080))
			{
				int num4 = 3000;
				if (Main.player[j].position.X > Main.invasionX * 16f - (float)num4 && Main.player[j].position.X < Main.invasionX * 16f + (float)num4)
				{
					flag4 = true;
				}
			}
			...
			else if (Main.player[j].position.Y > (float)((Main.rockLayer << 4) + 1080))
			{
				spawnRate = (int)((double)spawnRate * 0.4);
				maxSpawns = (int)((double)maxSpawns * 1.9);
			}
			else if (Main.player[j].position.Y > (float)((Main.worldSurface << 4) + 1080))
			{
				if (Main.hardMode)
				{
			...
			if (Main.player[j].zoneHoly && Main.player[j].position.Y > (float)((Main.rockLayer << 4) + 1080))
			{
				spawnRate = (int)((double)spawnRate * 0.65);
				maxSpawns = (int)((float)maxSpawns * 1.3f);
			}
			if (wof >= 0 && Main.player[j].position.Y > (float)((Main.maxTilesY - 200) * 16))
			{
				maxSpawns = (int)((float)maxSpawns * 0.3f);
				spawnRate *= 3;
			}
			if (Main.player[j].activeNPCs < (float)(int)((double)maxSpawns * 0.2))
			{
				spawnRate = (int)((float)spawnRate * 0.6f);
			}
			else if (Main.player[j].activeNPCs < (float)(int)((double)maxSpawns * 0.4))
			{
				spawnRate = (int)((float)spawnRate * 0.7f);
			}
			else if (Main.player[j].activeNPCs < (float)(int)((double)maxSpawns * 0.6))
			{
				spawnRate = (int)((float)spawnRate * 0.8f);
			}
			else if (Main.player[j].activeNPCs < (float)(int)((double)maxSpawns * 0.8))
			{
				spawnRate = (int)((float)spawnRate * 0.9f);
			}
			if (Main.player[j].position.Y * 16f > (float)(Main.worldSurface + Main.rockLayer >> 1) || Main.player[j].zoneEvil)
			{
			...
			bool flag6 = false;
			if (!flag4 && (!Main.gameTime.bloodMoon || Main.gameTime.dayTime) && !Main.player[j].zoneDungeon && !Main.player[j].zoneEvil && !Main.player[j].zoneMeteor)
			{
			...
			if (Main.player[j].activeNPCs < (float)maxSpawns && Main.rand.Next(spawnRate) == 0)
			{
				int num5 = Main.player[j].aabb.X >> 4;
				int num6 = Main.player[j].aabb.Y >> 4;
				int num7 = num5 - 84;
				int num8 = num5 + 84;
				int num9 = num6 - 46;
				int num10 = num6 + 46;
				...
				for (int k = 0; k < 48; k++)
				{
					...
					if ((Main.tile[num15, num16].active != 0 && Main.tileSolid[Main.tile[num15, num16].type]) || Main.wallHouse[Main.tile[num15, num16].wall])
					{
						continue;
					}
					if (!flag4 && !flag6 && ((num16 < (int)((float)Main.worldSurface * 0.35f) && (num15 < (int)((double)Main.maxTilesX * 0.45) || num15 > (int)((double)Main.maxTilesX * 0.55) || Main.hardMode)) || (num16 < (int)((float)Main.worldSurface * 0.45f) && Main.hardMode && Main.rand.Next(10) == 0)))
					{
						_ = Main.tile[num15, num16].type;
						num = num15;
						num2 = num16;
						flag = true;
						flag2 = true;
					...
					if (!flag)
					{
						...
						{
							if (Main.tile[num15, l].active != 0 && Main.tileSolid[Main.tile[num15, l].type])
							{
								if (num15 < num11 || num15 > num12 || l < num13 || l > num14)
								{
									_ = Main.tile[num15, l].type;
									num = num15;
									num2 = l;
									flag = true;
								}
					...
					else
					{
						for (int m = num17; m < num18; m++)
						{
							...
							{
								if (Main.tile[m, n].active != 0 && Main.tileSolid[Main.tile[m, n].type])
								{
									flag = false;
									break;
								}
								if (Main.tile[m, n].lava != 0)
								{
									flag = false;
									break;
								}
			...
			if (flag)
			{
				...
				{
					if (Main.player[num21].active != 0)
					{
						Rectangle rectangle2 = new Rectangle(Main.player[num21].aabb.X + 10 - 960 - 62, Main.player[num21].aabb.Y + 21 - 540 - 34, 2044, 1148);
						if (rectangle.Intersects(rectangle2))
						{
							flag = false;
							break;
			...
			else if ((num22 == 22 && Main.player[j].zoneEvil) || num22 == 23 || num22 == 25 || num22 == 112)
			{
				...
				{
					num23 = NewNPC(x, y, Main.rand.Next(3) switch
					{
						0 => 150, 
						1 => 81, 
						_ => 121, 
			...
			else if (num2 <= Main.worldSurface)
			{
				...
				{
					int num26 = Math.Abs(num - Main.spawnTileX);
					if (num26 < Main.maxTilesX / 3 && Main.rand.Next(15) == 0 && (num22 == 2 || num22 == 109 || num22 == 147))
					{
						NewNPC(x, y, 46);
					}
					else if (num26 < Main.maxTilesX / 3 && Main.rand.Next(15) == 0 && (num22 == 2 || num22 == 109 || num22 == 147))
					{
						NewNPC(x, y, 74);
					}
					else if (num26 > Main.maxTilesX / 3 && num22 == 2 && Main.rand.Next(300) == 0 && !AnyNPCs(50))
					{
						num23 = NewNPC(x, y, 50);
					}
					...
					else if (num26 > Main.maxTilesX / 3 && Main.rand.Next(15) == 0)
					{
						num23 = NewNPC(x, y, 73);
					}
					else
			...
			{
				num23 = ((Main.hardMode && (Main.player[j].zoneHoly & (Main.rand.Next(2) == 0))) ? NewNPC(x, y, 138) : (Main.player[j].zoneJungle ? NewNPC(x, y, 51) : ((Main.hardMode && Main.player[j].zoneHoly) ? NewNPC(x, y, 137) : ((!Main.hardMode || Main.rand.Next(6) <= 0) ? NewNPC(x, y, 49) : NewNPC(x, y, 93)))));
			}
			...
			{
				int num28 = ((Main.rand.Next(2) == 0) ? 44 : 149);
				num23 = NewNPC(x, y, num28);
			}
			else
			{
				num23 = NewNPC(x, y, 21);
	...
	public unsafe void NPCLoot()
	{
		...
		case ID.WALL_OF_FLESH:
		{
			...
			else
			{
				...
				Item.NewItem(aabb.X, aabb.Y, width, height, num3 switch
				{
					0 => 514, 
					1 => 426, 
					_ => 434, 
	...
	public unsafe void UpdateNPC(int i)
	{
		...
		float num3 = 10f;
		float num4 = 0.3f;
		float num5 = (float)Main.maxTilesX * 0.00023809524f;
		num5 *= num5;
	...
	public string GetChat(Player player)
	{
		...
		if (type == 17)
		{
			result = ((!downedBoss1 && Main.rand.Next(3) == 0) ? ((player.statLifeMax < 200) ? Lang.dialog(player, 1) : ((player.statDefense > 10) ? Lang.dialog(player, 3) : Lang.dialog(player, 2))) : (Main.gameTime.dayTime ? (((double)Main.gameTime.time < 16200.0) ? (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 4), 
				1 => Lang.dialog(player, 5), 
				_ => Lang.dialog(player, 6), 
			}) : (((double)Main.gameTime.time > 37800.0) ? (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 7), 
				1 => Lang.dialog(player, 8), 
				_ => Lang.dialog(player, 9), 
			}) : (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 10), 
				1 => Lang.dialog(player, 11), 
				_ => Lang.dialog(player, 12), 
			}))) : (Main.gameTime.bloodMoon ? ((flag2 && flag7 && Main.rand.Next(3) == 0) ? Lang.dialog(player, 13) : (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 14), 
				1 => Lang.dialog(player, 15), 
				2 => Lang.dialog(player, 16), 
				_ => Lang.dialog(player, 17), 
			})) : (((double)Main.gameTime.time < 9720.0) ? ((Main.rand.Next(2) != 0) ? Lang.dialog(player, 19) : Lang.dialog(player, 18)) : (((double)Main.gameTime.time > 22680.0) ? ((Main.rand.Next(2) != 0) ? Lang.dialog(player, 21) : Lang.dialog(player, 20)) : (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 22), 
				1 => Lang.dialog(player, 23), 
				_ => Lang.dialog(player, 24), 
			}))))));
		}
		else if (type == 18)
		{
			result = (Main.gameTime.bloodMoon ? (((double)player.statLife < (double)player.statLifeMax * 0.66) ? (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 25), 
				1 => Lang.dialog(player, 26), 
				_ => Lang.dialog(player, 27), 
			}) : (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 28), 
				1 => Lang.dialog(player, 29), 
				2 => Lang.dialog(player, 30), 
				_ => Lang.dialog(player, 31), 
			})) : ((Main.rand.Next(3) == 0 && !downedBoss3) ? Lang.dialog(player, 32) : ((flag6 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 33) : ((flag3 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 34) : ((flag9 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 35) : (((double)player.statLife < (double)player.statLifeMax * 0.33) ? (Main.rand.Next(5) switch
			{
				0 => Lang.dialog(player, 36), 
				1 => Lang.dialog(player, 37), 
				2 => Lang.dialog(player, 38), 
				3 => Lang.dialog(player, 39), 
				_ => Lang.dialog(player, 40), 
			}) : (((double)player.statLife < (double)player.statLifeMax * 0.66) ? (Main.rand.Next(7) switch
			{
				0 => Lang.dialog(player, 41), 
				1 => Lang.dialog(player, 42), 
				2 => Lang.dialog(player, 43), 
				3 => Lang.dialog(player, 44), 
				4 => Lang.dialog(player, 45), 
				5 => Lang.dialog(player, 46), 
				_ => Lang.dialog(player, 47), 
			}) : (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 48), 
				1 => Lang.dialog(player, 49), 
				2 => Lang.dialog(player, 50), 
				_ => Lang.dialog(player, 51), 
			}))))))));
		}
		else if (type == 19)
		{
			result = ((downedBoss3 && !Main.hardMode) ? Lang.dialog(player, 58) : ((flag2 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 59) : ((flag2 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 60) : ((flag4 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 61) : ((flag6 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 62) : ((flag6 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 63) : (Main.gameTime.bloodMoon ? ((Main.rand.Next(2) != 0) ? Lang.dialog(player, 65) : Lang.dialog(player, 64)) : (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 66), 
				1 => Lang.dialog(player, 67), 
				_ => Lang.dialog(player, 68), 
			}))))))));
		}
		else if (type == 20)
		{
			result = ((!downedBoss2 && Main.rand.Next(3) == 0) ? Lang.dialog(player, 69) : ((flag3 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 70) : ((flag && Main.rand.Next(4) == 0) ? Lang.dialog(player, 71) : ((flag5 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 72) : (Main.gameTime.bloodMoon ? (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 73), 
				1 => Lang.dialog(player, 74), 
				2 => Lang.dialog(player, 75), 
				_ => Lang.dialog(player, 76), 
			}) : (Main.rand.Next(5) switch
			{
				0 => Lang.dialog(player, 77), 
				1 => Lang.dialog(player, 78), 
				2 => Lang.dialog(player, 79), 
				3 => Lang.dialog(player, 80), 
				_ => Lang.dialog(player, 81), 
			}))))));
		}
		else if (type == 37)
		{
			result = (Main.gameTime.dayTime ? (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 82), 
				1 => Lang.dialog(player, 83), 
				_ => Lang.dialog(player, 84), 
			}) : ((player.statLifeMax < 300 || player.statDefense < 10) ? (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 85), 
				1 => Lang.dialog(player, 86), 
				2 => Lang.dialog(player, 87), 
				_ => Lang.dialog(player, 88), 
			}) : (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 89), 
				1 => Lang.dialog(player, 90), 
				2 => Lang.dialog(player, 91), 
				_ => Lang.dialog(player, 92), 
			})));
		}
		else if (type == 38)
		{
			...
			result = (Main.gameTime.bloodMoon ? (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 94), 
				1 => Lang.dialog(player, 95), 
				_ => Lang.dialog(player, 96), 
			}) : ((flag3 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 97) : ((flag3 && Main.rand.Next(5) == 0) ? Lang.dialog(player, 98) : ((flag2 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 99) : ((flag4 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 100) : ((!Main.gameTime.dayTime) ? (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 101), 
				1 => Lang.dialog(player, 102), 
				2 => Lang.dialog(player, 103), 
				_ => Lang.dialog(player, 104), 
			}) : (Main.rand.Next(5) switch
			{
				0 => Lang.dialog(player, 105), 
				1 => Lang.dialog(player, 106), 
				2 => Lang.dialog(player, 107), 
				3 => Lang.dialog(player, 108), 
				_ => Lang.dialog(player, 109), 
			})))))));
		}
		else if (type == 54)
		{
			result = ((!flag7 && Main.rand.Next(2) == 0) ? Lang.dialog(player, 110) : (Main.gameTime.bloodMoon ? Lang.dialog(player, 111) : ((flag2 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 112) : ((player.head == 24) ? Lang.dialog(player, 113) : (Main.rand.Next(6) switch
			{
				0 => Lang.dialog(player, 114), 
				1 => Lang.dialog(player, 115), 
				2 => Lang.dialog(player, 116), 
				3 => Lang.dialog(player, 117), 
				4 => Lang.dialog(player, 118), 
				_ => Lang.dialog(player, 119), 
			})))));
		}
		else if (type == 105)
		{
		...
		{
			result = (homeless ? (Main.rand.Next(5) switch
			{
				0 => Lang.dialog(player, 121), 
				1 => Lang.dialog(player, 122), 
				2 => Lang.dialog(player, 123), 
				3 => Lang.dialog(player, 124), 
				_ => Lang.dialog(player, 125), 
			}) : ((flag7 && Main.rand.Next(4) == 0) ? Lang.dialog(player, 126) : ((!Main.gameTime.dayTime) ? (Main.rand.Next(5) switch
			{
				0 => Lang.dialog(player, 127), 
				1 => Lang.dialog(player, 128), 
				2 => Lang.dialog(player, 129), 
				3 => Lang.dialog(player, 130), 
				_ => Lang.dialog(player, 131), 
			}) : (Main.rand.Next(5) switch
			{
				0 => Lang.dialog(player, 132), 
				1 => Lang.dialog(player, 133), 
				2 => Lang.dialog(player, 134), 
				3 => Lang.dialog(player, 135), 
				_ => Lang.dialog(player, 136), 
			}))));
		}
		else if (type == 106)
		{
		...
		else if (type == 108)
		{
			...
			else if (Main.gameTime.dayTime)
			{
				...
				{
					0 => Lang.dialog(player, 151), 
					1 => Lang.dialog(player, 152), 
					2 => Lang.dialog(player, 153), 
					3 => Lang.dialog(player, 154), 
					_ => Lang.dialog(player, 155), 
				};
			}
			else
			{
		...
		{
			result = (homeless ? (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 157), 
				1 => Lang.dialog(player, 158), 
				2 => Lang.dialog(player, 159), 
				_ => Lang.dialog(player, 160), 
			}) : (Main.gameTime.bloodMoon ? (Main.rand.Next(4) switch
			{
				0 => Lang.dialog(player, 161), 
				1 => Lang.dialog(player, 162), 
				2 => Lang.dialog(player, 163), 
				_ => Lang.dialog(player, 164), 
			}) : ((flag8 && Main.rand.Next(6) == 0) ? Lang.dialog(player, 165) : ((flag3 && Main.rand.Next(6) == 0) ? Lang.dialog(player, 166) : (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 167), 
				1 => Lang.dialog(player, 168), 
				_ => Lang.dialog(player, 169), 
			})))));
		}
		else if (type == 22)
		{
			result = (Main.gameTime.bloodMoon ? (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 170), 
				1 => Lang.dialog(player, 171), 
				_ => Lang.dialog(player, 172), 
			}) : ((!Main.gameTime.dayTime) ? Lang.dialog(player, 173) : (Main.rand.Next(3) switch
			{
				0 => Lang.dialog(player, 174), 
				1 => Lang.dialog(player, 175), 
				_ => Lang.dialog(player, 176), 
			})));
		}
		else if (type == 142)
		{
