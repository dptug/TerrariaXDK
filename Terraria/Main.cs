	...
	public sealed class Main : Game
	{
		...
		private static void UpdateTutorial()
		{
			...
			case Tutorial.HOUSE_INFO_2:
				break;
			case Tutorial.MOVE:
				if (UI.main.gpState.ThumbSticks.Left.LengthSquared() > 0.015625f)
				{
					tutorialVar++;
				}
			...
			case Tutorial.CURSOR:
				if (UI.main.gpState.ThumbSticks.Right.LengthSquared() > 0.015625f)
				{
					tutorialVar++;
				}
