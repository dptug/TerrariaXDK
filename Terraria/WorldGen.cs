...
internal static class WorldGen
{
	...
	public unsafe static void UpdateSand()
	{
		...
		do
		{
			...
			{
				ptr->active = 0;
				int num2 = Projectile.NewProjectile(x * 16 + 8, y * 16 + 8, 0f, 2.5f, ptr->type switch
				{
					112 => 56, 
					116 => 67, 
					123 => 71, 
	...
	public static void dropMeteor()
	{
		...
		int num2 = 0;
		float num3 = (float)Main.maxTilesX * 0.00023809524f;
	...
	private unsafe static void loadOldWorld(BinaryReader fileIO, int release)
	{
		...
		for (int j = 0; j < 1000; j++)
		{
			...
			for (int k = 0; k < 20; k++)
			{
				...
				if (b > 0)
				{
					Main.chest[j].item[k].netDefaults(fileIO.ReadInt32(), b);
		...
		if (!flag2 || text3 != text || num6 != Main.worldID)
		{
	...
	public unsafe static void generateWorld(int seed = -1)
	{
		...
		fixed (Tile* ptr = Main.tile)
		{
			...
			Main.worldSurfacePixels = Main.worldSurface << 4;
			int num12 = (int)((num8 - num6 + 25f) * (1f / 6f)) * 6;
			...
			for (int n = 0; n < num15; n++)
			{
				...
				if (n == 1)
				{
					float num18 = (float)Main.maxTilesX * 0.00023809524f;
			...
			if (flag3)
			{
				...
				float num34 = (float)Main.maxTilesX * 0.00047619047f;
			...
			num55 = (int)((float)Main.maxTilesX * 0.0011904762f);
			...
			float num74 = (float)Main.maxTilesX * 0.00035714285f;
			...
			int num94 = (int)((float)(genRand.Next(6, 10) * Main.maxTilesX) * 0.00023809524f);
			...
			do
			{
				...
				while (Liquid.numLiquid > 0)
				{
					...
					if (num229 == 1)
					{
						UI.main.progress = num232 * (1f / 3f) + 0.3334f;
					}
					int num233 = 10;
					if (num229 > num233)
					{
			...
			float num236 = (float)Main.maxTilesX * 0.00023809524f;
			int num237 = 0;
				...
				do
				{
					if (num < Main.worldSurface + 25)
					{
						...
						if (genRand.Next(3) > 0)
						{
							...
							genRand.Next(1, 3);
							Main.chest[num2].item[num3].SetDefaults(num4 switch
							{
								0 => 292, 
								1 => 298, 
								2 => 299, 
					...
					if (num < Main.rockLayer)
					{
						...
						if (genRand.Next(3) > 0)
						{
							...
							Main.chest[num2].item[num3].SetDefaults(num7 switch
							{
								0 => 289, 
								1 => 298, 
								2 => 299, 
					...
					if (num < Main.maxTilesY - 250)
					{
						...
						{
							int num8 = genRand.Next(7);
							if (num8 == 2 && genRand.Next(2) == 0)
							{
								num8 = genRand.Next(7);
							}
							switch (num8)
						...
						if (genRand.Next(2) == 0)
						{
							...
							Main.chest[num2].item[num3].stack = (short)num10;
							num3++;
						}
						if (genRand.Next(2) == 0)
						{
							int num11 = genRand.Next(2);
							int num12 = genRand.Next(26) + 25;
							if (num11 == 0)
							{
							...
							Main.chest[num2].item[num3].stack = (short)num12;
							num3++;
						}
						if (genRand.Next(2) == 0)
						{
							int num13 = genRand.Next(1);
							int num14 = genRand.Next(3) + 3;
							if (num13 == 0)
							{
								Main.chest[num2].item[num3].SetDefaults(188);
							}
							Main.chest[num2].item[num3].stack = (short)num14;
							num3++;
						}
						if (genRand.Next(3) > 0)
						{
							int num15 = genRand.Next(6);
							int num16 = genRand.Next(1, 3);
							if (num15 == 0)
							{
							...
							Main.chest[num2].item[num3].stack = (short)num16;
							num3++;
						}
						if (genRand.Next(3) > 1)
						{
							int num17 = genRand.Next(4);
							int num18 = genRand.Next(1, 3);
							if (num17 == 0)
							{
							...
							Main.chest[num2].item[num3].stack = (short)num18;
							num3++;
						}
						if (genRand.Next(2) == 0)
						{
							int num19 = genRand.Next(2);
							int num20 = genRand.Next(15) + 15;
							if (num19 == 0)
							{
							...
							Main.chest[num2].item[num3].stack = (short)num20;
							num3++;
						}
						if (genRand.Next(2) == 0)
						{
					...
					if (genRand.Next(2) == 0)
					{
						...
						Main.chest[num2].item[num3].stack = (short)num22;
						num3++;
					}
					if (genRand.Next(2) == 0)
					{
						int num23 = genRand.Next(2);
						int num24 = genRand.Next(25) + 50;
						if (num23 == 0)
						{
						...
						Main.chest[num2].item[num3].stack = (short)num24;
						num3++;
					}
					if (genRand.Next(2) == 0)
					{
						int num25 = genRand.Next(2);
						int num26 = genRand.Next(15) + 15;
						if (num25 == 0)
						{
						...
						Main.chest[num2].item[num3].stack = (short)num26;
						num3++;
					}
					if (genRand.Next(4) > 0)
					{
						int num27 = genRand.Next(7);
						int num28 = genRand.Next(1, 3);
						if (num27 == 0)
						{
							Main.chest[num2].item[num3].SetDefaults(296);
						}
						...
						Main.chest[num2].item[num3].stack = (short)num28;
						num3++;
					}
					if (genRand.Next(3) > 0)
					{
						int num29 = genRand.Next(5);
						...
						Main.chest[num2].item[num3].stack = (short)num30;
						num3++;
					}
					if (genRand.Next(2) == 0)
					{
						int num31 = genRand.Next(2);
						int num32 = genRand.Next(15) + 15;
						if (num31 == 0)
						{
							Main.chest[num2].item[num3].SetDefaults(8);
						}
						...
						Main.chest[num2].item[num3].stack = (short)num32;
						num3++;
					}
					else if (genRand.Next(48) == 0)
					{
	...
	public static void Check2xX(int i, int j, int type)
	{
		...
		if (!gen)
		{
			...
			{
				int num6 = frameX / 36;
				Item.NewItem(num * 16, j * 16, 32, 32, num6 switch
				{
					0 => 360, 
					1 => 52, 
					_ => 438 + num6 - 2, 
	...
	public static void Check4x2(int i, int j, int type)
	{
		...
		for (int k = num; k < num + 4; k++)
		{
			for (int l = num2; l < num2 + 2; l++)
			{
				...
				if (Main.tile[k, l].active == 0 || Main.tile[k, l].type != type || Main.tile[k, l].frameX != num3 || Main.tile[k, l].frameY != (l - num2) * 18)
				{
					Destroy4x2(i, j, num, num2, type);
					return;
				}
			}
			if (Main.tile[k, num2 + 2].active == 0 || !Main.tileSolid[Main.tile[k, num2 + 2].type])
			{
				Destroy4x2(i, j, num, num2, type);
				break;
			}
	...
	public unsafe static void MineHouse(int i, int j)
	{
		...
		for (int num41 = 0; num41 < 4; num41++)
		{
			...
			if (Main.tile[num42, num43].wall == 27)
			{
				if (genRand.Next(3) == 0)
				{
					PlaceTile(num42, num43, genRand.Next(9) switch
					{
						0 => 14, 
						1 => 16, 
						2 => 18, 
					...
					if (ptr2->active != 0)
					{
						...
						default:
							...
							case 70:
							{
								...
								if (genRand.Next(200) == 0 && !PlayerLOS(num24, num25))
								{
	...
	public static void GERunner(int i, Vector2 speed, bool good, ref Vector2i minArea, ref Vector2i maxArea)
	{
		...
		float num2 = (float)Main.maxTilesX * 0.00023809524f;
