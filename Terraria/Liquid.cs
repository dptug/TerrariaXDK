				...
				if (ptr->liquid > 0)
				{
					...
					if (flag && flag2)
					{
						if (flag3 && flag4)
						{
							...
							if (flag5 && flag6)
							{
								int num3 = ptr[-1440].liquid + ptr[1440].liquid + ptr[-2880].liquid + ptr[2880].liquid + ptr[-4320].liquid + ptr[4320].liquid + ptr->liquid + num5;
								num3 = (num3 + 3) / 7;
								int num6 = 0;
							...
							{
								int num7 = 0;
								int num3 = ptr[-1440].liquid + ptr[1440].liquid + ptr[-2880].liquid + ptr[2880].liquid + ptr->liquid + num5;
								num3 = (num3 + 2) / 5;
								ptr[-1440].lava = ptr->lava;
								if (ptr[-1440].liquid != num3)
								{
						...
						{
							int num3 = ptr[-1440].liquid + ptr[1440].liquid + ptr[-2880].liquid + ptr->liquid + num5;
							num3 = num3 + 2 >> 2;
							ptr[-1440].lava = ptr->lava;
							if (ptr[-1440].liquid != num3 || ptr->liquid != num3)
							{
						...
						{
							int num3 = ptr[-1440].liquid + ptr[1440].liquid + ptr->liquid + num5;
							num3 = (num3 + 1) / 3;
							ptr[-1440].lava = ptr->lava;
							if (ptr[-1440].liquid != num3)
							{
					...
					{
						int num3 = ptr[-1440].liquid + ptr->liquid + num5;
						num3 = num3 + 1 >> 1;
						if (ptr[-1440].liquid != num3)
						{
							ptr[-1440].liquid = (byte)num3;
