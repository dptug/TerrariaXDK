...
public sealed class TextSequenceBlock
{
	...
	public static readonly string[] TIPS_EN = new string[78]
	{
		...
		"Press " + '\u0085' + " to switch between Cursor Modes.",
		"Bows and guns require the proper <i>ammo</i> in your Ammo slots.",
		"If your Inventory is full, you can press " + '\u008a' + " to send items to the Trash.",
		...
		"Bind items to your " + '\u0086' + " for quick access!",
		"By default, " + '\u008e' + " is an alternate jump button. Advanced players may wish to switch the grappling and alternate jump buttons; you can do this from the Controls Menu.",
		"Wear a <i>Mining Helmet</i> if you don't want to use torches.",
		"You can wear <i>buckets</i>!",
		"You can remove torches with " + '\u008d' + ".",
		...
		"In your Inventory, you can press " + '\u008b' + " to equip items such as armor or accessories directly to a usable slot.",
	...
	public static readonly string[] TIPS_DE = new string[78]
	{
		...
		"Manche Gegenstände kannst du kontinuierlich benutzen, indem du " + '\u0081' + " gedrückt hältst.",
		...
		"Drücke " + '\u0085' + " , um zwischen den Cursor Modi zu wechseln.",
		"Bögen und Pistolen benötigen die richtige <I>Munition</I> in deinen Ammo-Slots.",
		"Wenn dein Inventar voll ist, kannst du durch Drücken von " + '\u008a' + " einen Gegenstand in den Müll werfen.",
		"Wenn du mit einem Verkäufer sprichst, kannst du Gegenstände in deinem Inventar verkaufen, indem du " + '\u008a' + " drückst.",
		...
		"Lege für einen schnelleren Zugriff Gegenstände auf dein " + '\u0086' + " !",
		"Standardmäßig ist " + '\u008e' + " ein alternativer Knopf zum Springen. Fortgeschrittene Spieler möchten vielleicht die Knöpfe für Festhaken und Springen austauschen. Dies ist im Steuerungsmenü möglich.",
		"Trage einen <I>Minenhelm</I>, wenn du keine Fackeln benutzen möchtest.",
		"Du kannst <I>Eimer</I> tragen!",
		"Du kannst Fackeln mit " + '\u008d' + " entfernen.",
		...
		"In deinem Inventar kannst du " + '\u008b' + " drücken, um Gegenstände wie Rüstung und Zubehör direkt einem offenen Slot zuzuweisen.",
	...
	public static readonly string[] TIPS_IT = new string[78]
	{
		...
		"Tenendo premuto " + '\u0081' + " è possibile utilizzare continuamente alcuni oggetti.",
		...
		"Premi " + '\u0085' + " per cambiare la modalità Cursore.",
		"Archi e pistole richiedono apposite <i>munizioni </i>che troverai nelle sezioni per le munizioni.",
		"Quando l'Inventario è pieno, è possibile spostare gli oggetti nel Cestino, premendo " + '\u008a' + ".",
		"Mentre parli con il venditore, è possibile vendere gli oggetti presenti nel tuo Inventario, premendo " + '\u008a' + ".",
		...
		"Per un accesso rapido, configura gli oggetti con " + '\u0086' + ".",
		"Per impostazione predefinita, " + '\u008e' + " è un pulsante alternativo per saltare. I giocatori più esperti possono cambiare la modalità di lotta e alternare i pulsanti per saltare. È possibile eseguire questa azione dal menu Comandi.",
		"Se non vuoi utilizzare le torce, indossa un <i>Casco da minatore</i>.",
		"Puoi utilizzare i <i>secchi!</i>",
		"È possibile rimuovere le torce con " + '\u008d' + ".",
		...
		"È possibile premere " + '\u008b' + " nell'Inventario, per equipaggiarsi di un'armatura o un accessorio direttamente da una sezione disponibile",
	...
	public static readonly string[] TIPS_FR = new string[78]
	{
		...
		"Vous pouvez utiliser certains objets en continu en maintenant " + '\u0081' + ".",
		...
		"Appuyez sur " + '\u0085' + " pour changer le mode curseur.",
		"Il vous faut des <I>munitions</I> dans vos emplacements Munitions pour vos arcs et armes à feu.",
		"Si votre inventaire est plein, vous pouvez mettre des objets à la poubelle en appuyant sur " + '\u008a' + ".",
		"Lorsque vous parlez à un vendeur, vous pouvez vendre les objets de votre inventaire en appuyant sur " + '\u008a' + ".",
		...
		"Installez des objets sur votre " + '\u0086' + " pour un accès rapide\u00a0!",
		"Par défaut, " + '\u008e' + " est une alternative au bouton de saut. Les joueurs expérimentés souhaiteront peut-être changer le grappin et alterner les boutons de saut\u00a0; ceci est possible depuis le menu Commandes.",
		"Portez un <I>casque de mineur</I> si vous ne voulez pas utiliser de torches.",
		"Vous pouvez même porter des <I>seaux</I> vides\u00a0!",
		"Vous pouvez supprimer des torches avec " + '\u008d' + ".",
		...
		"Dans votre inventaire, vous pouvez appuyer sur " + '\u008b' + " pour équiper les objets tels que les armures ou les accessoires dans des emplacements permettant une utilisation directe.",
	...
	public static readonly string[] TIPS_ES = new string[78]
	{
		...
		"Puedes usar continuamente varios objetos manteniendo presionado " + '\u0081' + ".",
		...
		"Pulsa " + '\u0085' + " para cambiar el modo de cursor.",
		"Los arcos y armas necesitan que coloques la <I>munición</I> adecuada en las ranuras de munición.",
		"Si tienes el inventario lleno, puedes pulsar " + '\u008a' + " para enviar objetos a la basura.",
		"Cuando hables con un comerciante, puedes venderle objetos de tu inventario pulsando " + '\u008a' + ".",
		...
		"¡Enlaza objetos al " + '\u0086' + " para acceder a ellos rápidamente!",
		"Por defecto, " + '\u008e' + " es el botón de salto alternativo. Puede que los jugadores más experimentados prefieran cambiar los botones de agarre y salto alternativo. Esto se puede hacer desde el menú Controles.",
		"Si no quieres usar antorchas puedes llevar un <I>casco de minero</I>.",
		"¡Puedes llevar <I>cubos</I>!",
		"Puedes retirar antorchas con " + '\u008d' + ".",
		...
		"En el inventario, puedes pulsar " + '\u008b' + " para equipar objetos como la armadura o los accesorios, moviéndolos directamente a una ranura adecuada.",
	...
	public static void GenerateCache(GraphicsDevice gfx)
	{
		...
		case Lang.ID.FRENCH:
			array = TIPS_FR;
			break;
		case Lang.ID.ITALIAN:
			array = TIPS_IT;
			break;
		case Lang.ID.SPANISH:
			array = TIPS_ES;
			break;
		}
		...
		{
			CompiledText compiledText = new CompiledText(array[i], 450, UI.styleFontSmallOutline);
			Rectangle textArea = new Rectangle(TipCenter.X, TipCenter.Y, 0, 0);
			textArea.Inflate(compiledText.Width >> 1, compiledText.Height + UI.fontSmallOutline.LineSpacing >> 1);
			blocks[i] = new TextBlock(ref dialogArea, compiledText, ref textArea, Assets.TEXT_BACKGROUND, Assets.TEXT_BACKGROUND_BORDER_WIDTH, UI.DEFAULT_DIALOG_COLOR, Color.White, Color.DarkOrange);
	...
	public static TextSequenceBlock CreateTips()
	{
		...
		return new TextSequenceBlock(startIndex, 480);
	}
